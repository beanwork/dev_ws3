...
int move_servo(int current_floor, int target_floor)
{
...
{ 
  ...
  if(btn_flag == 1)
  {
    if (digitalRead(btn_1) == HIGH) 
    {
      ...
      current_floor = move_servo(current_floor, 1);
    }
  }
  ...
  if(btn_flag == 1)
  {
    if (digitalRead(btn_2) == HIGH) 
    {
      ...
      current_floor = move_servo(current_floor, 2);
    }
  }
  ...
  if(btn_flag == 1)
  {
    if (digitalRead(btn_3) == HIGH) 
    {
      ...
      current_floor = move_servo(current_floor, 3);
    }
  }
